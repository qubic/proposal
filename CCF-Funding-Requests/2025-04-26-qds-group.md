...
- Compensating for small loss through staking protocol as we do believe we have seen the floor at ~$900/billion Qubic.
- Further accelerating burns through interaction and usage of Qearn SC
...
- Build two key products (smart indexer and smart contract IDE) to make development more seamless.
...
- Provide business development and marketing assistance to other teams within Qubic (depending on engagement level without fees).  In the event more than 10 hours are needed an agreed upon contract rate must be paid in Qubic only to help drive buy pressure.
...
## Success Indicators
- Smart Contract IDE & Smart Indexer are released to public by 7/31/2025
- Corresponding documentation and software is in use by teams/entities external to Qubic
- Top of funnel pipeline is formed by business development and marketing to cultivate partnerships
...
- Full time European Business Development Manager
- Part time organizational lead
- Social Media Lead

$124K Ardata - all web design, digital artifacts and two keystone projects along with documentaton, comes with PM and QA liaison
$25K Schreck - US BD, org lead
$36K Alber - European BD lead
$54K Jen - CMO
$36K Jay - GTM manager
$100K Travel, Infra, Web Expenses, Collateral Development, Marketing Spend for social platforms and necessary licensing for 1 calendar year. This includes things like events spin-up compute infra and other costs.  The infra would be covered for 1 year along with licensing and ad budget, however travel/event portion would be refreshed each quarter based on renewed proposals.  The $100K would also include the 3 month salary for social media lead TBD.

Future QDS plans:
- Solana Bridge for Qubic
- More advanced SDK for SC development
- Functional test net with automation
...
- To ensure transparency and proper management of CCF funds, the Qubic Developer Services team will grant QCB and/or an independent community team access to all relevant documentation, including salary details, service invoices, and transaction history.
