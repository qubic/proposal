# Upgrade Supply Watcher (SWATCH) – Distribute Burn Across Infrastructure SCs

## Proposal

Upgrade the existing SWATCH smart contract to distribute burns evenly across all infrastructure smart contracts.
...
The infrastructure smart contracts do not generate their own burns. To ensure they can continue operating after execution fees are introduced, the SWATCH contract, which generates a significant amount of burn, will distribute these burns to them.

This ensures that the fee reserves of all infrastructure contracts are filled evenly.
...
From [https://github.com/qubic/core/pull/638](https://github.com/qubic/core/pull/723)
