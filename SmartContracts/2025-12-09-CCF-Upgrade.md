# Upgrade Computor Controlled Fund (CCF) - Intervall Payments

## Proposal

Upgrade the existing CCF Smart Contract to allow periodic payments.

## Available Options

Option 0: No, do not upgrade the contract.

Option 1: Yes, approve the upgrade.

## Details of the Upgrade

The original CCF contract can only do one time payments. The new periodical payments shall allow workgroups to request funding over a period (max 52 weeks) with a fixed value of Qubic.
The intervals are week/epoch based. For example monthly (every 4 weeks).

When the Qubic OM are available the contract may be updated to payout a certain amount per period based on real price.

Detailed description: https://github.com/qubic/core/issues/598

# Technical implementation

From https://github.com/qubic/core/pull/638
