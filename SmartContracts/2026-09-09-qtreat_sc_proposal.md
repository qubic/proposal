# Smart Contract - QDOGE Treasury (QTREAT)

## Proposal
Allow Deployment of the QTREAT Smart Contract on Qubic
...
QTREAT is a new smart contract for the **QDOGE protocol** that automates dividend payouts, QDOGE staking, NFT-based mining rewards, and a raffle, all funded from a shared treasury. This is an initial deployment proposal, not an upgrade — the contract does not yet exist on-chain and introduces no changes to any existing contract.

- **Staking** rewards from a fixed 20,000,000 QU/epoch pool, with bonuses for genuine accumulation
- **Dividends** shared between QTREAT holders and the Qdoge NFT 1.0 collection
- **Mining rewards** for registered ASIC rigs, verified live against the QBAY marketplace
- **A per-epoch raffle** seeded by on-chain entropy, with equal odds for every wallet
- **Dividends** 95% goes to Qtreat holders | 5% shareholders
...
Deploying QTREAT gives the QDOGE protocol:

- Automated, transparent dividend distribution to token and NFT holders
