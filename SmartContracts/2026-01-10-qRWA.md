# Smart Contract - Qubic Real World Asset (qRWA)

## Propoal
Allow Deployment of the qRWA Smart Contract in EP196 on Qubic
...
The qRWA (Qubic Real World Asset) smart contract is a decentralized governance and revenue distribution protocol for the Qubic ecosystem. It acts as a DAO (Decentralized Autonomous Organization) for the qMINE asset, enabling token holders to govern protocol parameters, vote on Qubic proposals, and manage on-chain revenue streams.

The contract automates revenue ingestion, applies operational fees where appropriate, and ensures transparent, deterministic distribution to token holders and smart contract shareholders.

It allows token holders to:

- Vote on protocol parameters  
- Vote on Qubic proposals  
- Manage a treasury of mining and other on-chain assets  
- Receive automated dividends  

Snapshot-based governance ensures that voting power is secure and resistant to flash-voting attacks, providing a safe and predictable decision-making process.

The contract collects revenue from mining operations and other assets, applies operational fees where necessary, and distributes net revenue fairly and transparently.
...
### Native Governance Asset — qMINE
- Asset Name: qMINE  
- This asset determines voting power, while dividends are shared between qMINE holders and qRWA Smart Contract shareholders.
...
### Revenue Pools
- Pool A — Mining Revenue: Income from mining; operational fees for electricity, maintenance, and reinvestment apply.  
- Pool B — Asset Revenue: Income from other assets or smart contract dividends; no operational fees.

### Net Revenue Distribution
- 90% → qMINE token holders  
- 10% → qRWA Smart Contract shareholders  

- qRWA SC shareholders receive 10% of current revenue (Qubic mining and Qubic SC shares). Any additional future income streams will be allocated according to governance votes by qMINE token holders.

### Operational Fees (Pool A only)
- 35% — Electricity  
- 5% — Maintenance  
- 10% — Reinvestment  

- Note: Operational fees are configurable and can be changed via governance votes by qMINE holders. Changes require a super-majority 2/3+1 Quorum votes to be approved.  
- Fee Extraction: If valid, operational fees from Pool A are automatically calculated and transferred to the designated electricityAddress, maintenanceAddress, and reinvestmentAddress.

### Dividend Distribution Schedule & Remainder Handling
- Scheduled dividend distribution: Friday, 12:00 UTC  
- Tokens transferred or sold during an epoch do not qualify for that epoch's dividend; unclaimed portions are automatically redirected to qmineDevAddress.  
- This ensures all dividend distributions are fully deterministic and transparent, with no ambiguity or leftover funds.

---

## Governance
- Voting power is calculated using snapshot-based balances: min(Begin_Epoch, End_Epoch)  
- qMINE holders can vote on protocol parameters, operational fees, and Qubic proposals  
- Admin proposals are executed automatically if approved  
- Voting thresholds: super-majority 2/3+1 Quorum votes  

---

## Conclusion
Deploying qRWA in EP196 ensures:

- Transparent and automated dividend payouts  
- Scheduled distribution: Friday, 12:00 UTC  
- Secure, snapshot-based governance  
- Sustainable management of mining and other asset revenue  
- Fair handling of leftover dividends  

- Approval guarantees qMINE holders and SC shareholders benefit fairly, while governance remains decentralized and secure.

## Technical implementation
From: https://github.com/qubic/core/pull/703
