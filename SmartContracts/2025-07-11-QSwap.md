# Proposal to include QSwap Smart Contract

## Proposal
Allow QSwap Smart Contract to be deployed on Qubic. 
...
## What is QSwap
QSwap is a cutting-edge decentralized exchange (DEX) built on Qubic blockchain technology. Inspired by the success of platforms like Uniswap, QSwap is designed to provide users with a seamless, secure, and efficient way to trade digital assets in a peer-to-peer environment. Our mission is to empower users with financial freedom, transparency, and control over their assets, while fostering a vibrant and inclusive ecosystem for decentralized finance.


## QSwap Key Features
1. **Automated Liquidity Pools:** At the heart of QSwap are automated liquidity pools, where users can provide liquidity by depositing token pairs. In return, liquidity providers (LPs) earn a share of the trading fees generated within the platform. This innovative model ensures continuous market liquidity and eliminates the need for traditional order books.
2. **Automated Market Making (AMM):** Leveraging the power of smart contracts, QSwap utilizes an AMM protocol to enable seamless and efficient trading. Prices are determined by mathematical formulas, ensuring fair and transparent exchanges between tokens. This approach allows users to trade directly from their qubic wallets without relying on intermediaries.
3. **​Low Trading Fees:** ​​Due to Qubic's advantages, QSwap charges minimal trading fees, a portion of which is redistributed to liquidity providers as rewards. This structure ensures a sustainable and rewarding ecosystem for all participants.
4. **Security and Transparency:** ​Security is our top priority. QSwap is built on Qubic which is a robust blockchain infrastructure with rigorous smart contract audits to ensure the safety of user funds. All transactions are recorded on the blockchain, providing complete transparency and trustless interactions.

## Fee Income Distribution
> 20% for Dev team

> 16% for share holders

> 64% for LP

## Technical Implementation
From: https://github.com/qubic/core/pull/260
