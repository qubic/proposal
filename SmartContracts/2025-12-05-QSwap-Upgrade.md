# Proposal: Upgrade QSwap with new fee distribution

## Proposal

Upgrade the existing QSwap Smart Contract to adapt the new fee distribution scheme worked out by the community. 
...
The original QSwap contract used to have the below distribution scheme:
...
The updated version of QSwap implements the new scheme:

```
64% LP
27% Shareholders
5% QX
3% Reinvest and Reward
1% Burn
```

# Technical implementation

From https://github.com/qubic/core/pull/644
