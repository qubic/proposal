...
Pulse is a 6-of-9 lottery smart contract operating on the Qubic blockchain.
Players select 6 unique digits from the range [0, 9], and prizes are awarded
based on matches against 9 unique winning digits drawn each round.
...
- **Left-aligned matches:** best contiguous alignment of the 6 digits inside the 9 winning digits
- **Any-position matches:** how many of the 6 digits appear anywhere in the 9 winning digits
...
4. Generate 9 unique winning digits
