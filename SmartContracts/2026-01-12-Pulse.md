...
- **Left-aligned matches:** longest consecutive run when comparing digits at the same positions
- **Any-position matches:** how many unique digits appear in both the ticket and winning digits
