...
Pulse is a 6-of-10 lottery smart contract operating on the Qubic blockchain.
Players select 6 unique digits from the range [0, 9], and prizes are awarded
based on matches against 10 unique winning digits drawn each round.
...
- Players choose **6 unique digits** from **[0, 9]**
- Duplicate digits or out-of-range digits are rejected
...
2. Contract validates:
   - Selling is open
   - Digits are unique and in range
...
- **Left-aligned matches:** best contiguous alignment of the 6 digits inside the 10 winning digits
- **Any-position matches:** how many of the 6 digits appear anywhere in the 10 winning digits
...
4. Generate 10 unique winning digits
...
- **Digit validation**: range and uniqueness checks
